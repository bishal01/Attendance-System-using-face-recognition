...
# -----------------Student Button--------------------------------------------------------------------
        ...
        b1_1=Button(bg_img,text="Student Details",command=self.student_details,cursor="hand2",font=("times new roman",14,"bold"),bg="darkblue",fg="white")
...
# ----------------------Detector Button------------------------------------------------------------------------------
        ...
        b2_2 = Button(bg_img,command=self.face_data ,text="Face Detector", cursor="hand2", font=("times new roman", 14, "bold"),
...
# ----------------------Attendance Face Button------------------------------------------------------------------------------
        ...
        b3_3 = Button(bg_img, text="Attendance", cursor="hand2", font=("times new roman", 14, "bold"),
                      bg="darkblue", fg="white")
...
# ------------------------------------Exit-------------------------------------------------------------
        ...
        b8_8 = Button(bg_img, text="Exit", cursor="hand2", font=("times new roman", 14, "bold"),
                      bg="darkblue", fg="white")
