...
# -----------------------------------------------------------------------------------------------
        title = Label(bg_img, text="STUDENT MANAGEMENT SYSTEM", font=("times new roman", 20, "bold"),
                  bg="white", fg="darkgreen")
        title.place(x=0, y=0, width=1400, height=40)
        main_frame=Frame(bg_img,bd=2)
        main_frame.place(x=0,y=0,width=1400,height=800)

        left_frame=LabelFrame(main_frame,bd=3,bg="#d4cbb4",relief=RIDGE,text="student Details", font=("times new roman", 15, "bold"), fg="darkgreen")
        ...
        level_frame = LabelFrame(left_frame, bd=3, bg="#d4cbb4", relief=RIDGE, text="current course information", width=14,
                        font=("times new roman", 20, "bold"), fg="darkgreen")
        level_frame.place(x=5, y=135, width=670, height=160)

        dept_label=Label(level_frame,text="Department", font=("times new roman", 13, "bold"), fg="darkgreen",width=14)
        dept_label.grid(row=0,column=0,padx=10,sticky=W)

        dep_combo=ttk.Combobox(level_frame, textvariable=self.var_dep, font=("times new roman", 12, "bold"), state="readonly", width=14)
        dep_combo["values"]=("Select Department","computer science","computer engineering")
        dep_combo.current(0)
        dep_combo.grid(row=0,column=1,padx=2,pady=10,sticky=W)


        course_label=Label(level_frame,text="Course", font=("times new roman", 13, "bold"), fg="darkgreen")
        course_label.grid(row=0,column=2,padx=10,sticky=W)

        course_combo=ttk.Combobox(level_frame,textvariable=self.var_course,  font=("times new roman", 12, "bold"), state="readonly", width=14)
        ...
        yr_label=Label(level_frame,text="Year", font=("times new roman", 13, "bold"), fg="darkgreen")
        ...
        yr_combo["values"]=("select-year","2020-2022","2021-2023","2022-2025")
        yr_combo.current(0)
        yr_combo.grid(row=1,column=1,padx=2,pady=10,sticky=W)

        sem_label=Label(level_frame,text="Semester", font=("times new roman", 13, "bold"), fg="darkgreen")
        ...
        sID_label = Label(class_frame, text="Student_Id", font=("times new roman", 13, "bold"), fg="darkgreen")
        ...
        sname_label = Label(class_frame, text="Student Name", font=("times new roman", 13, "bold"), fg="darkgreen")
        ...
        division_label = Label(class_frame, text="Class Division", font=("times new roman", 13, "bold"), fg="darkgreen")
       ...
       # division_entry.grid(row=1,column=1,padx=10,pady=5,sticky=W)
        ...
        roll_label = Label(class_frame, text="Roll No:", font=("times new roman", 13, "bold"),fg="darkgreen")
        ...
        btn_frame=Frame(class_frame,bd=3,relief=RIDGE,bg="#ffa1a1")
        btn_frame.place(x=0,y=100,width=669,height=60)

        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=16,font=("times new roman", 13, "bold"),bg="#383945",fg="#d5d7f2")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame ,command=self.update_data,text="Update",width=16,font=("times new roman", 13, "bold"),bg="#383945",fg="#d5d7f2")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,command=self.delete_data,text="Delete",width=16,font=("times new roman", 13, "bold"),bg="#383945",fg="#d5d7f2")
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(btn_frame,command=self.reset,text="Reset",width=16,font=("times new roman", 13, "bold"),bg="#383945",fg="#d5d7f2")
        reset_btn.grid(row=0,column=3)

        btn_frame1=Frame(class_frame,bd=3,relief=RIDGE,bg="#ffa1a1")
        btn_frame1.place(x=0,y=160,width=669,height=30)

        take_photo_sample=Button(btn_frame1,command=self.generate_dataset,width=34,text="Take Photo Sample",font=("times new roman", 13, "bold"),bg="#383945",fg="#d5d7f2")
        take_photo_sample.grid(row=0,column=0)

        update_photo_sample=Button(btn_frame1,width=34,text="Update Photo Sample",font=("times new roman", 13, "bold"),bg="#383945",fg="#d5d7f2")
        ...
        Search_frame = LabelFrame(right_frame, bd=3, bg="#d4cbb4", relief=RIDGE, text="Search System", width=12,
                        font=("times new roman", 20, "bold"), fg="darkgreen")
        Search_frame.place(x=5, y=140, width=670, height=100)


        search_label = Label(Search_frame, text="SearchBy", font=("times new roman", 12, "bold"), fg="darkgreen")
        ...
        delete_btn=Button(Search_frame,text="Search",width=13,font=("times new roman", 11, "bold"),bg="#383945",fg="#d5d7f2")
        delete_btn.grid(row=0,column=2)
        ...
        Show_btn=Button(Search_frame,text="Show All",width=13,font=("times new roman", 11, "bold"),bg="#383945",fg="#d5d7f2")
        Show_btn.grid(row=0,column=4)

        table_frame = LabelFrame(right_frame, bd=3, bg="#d4cbb4", relief=RIDGE, text="Student Details", width=12,
                        font=("times new roman", 20, "bold"), fg="darkgreen")
        ...
        if self.var_dep.get()=="Select Department" or self.var_student_name.get()=="" or self.var_SID.get()=="" :
            ...
            try:
                ...
                if up>0:
                        ...
                        my_curser.execute("update student set dep=%s,course=%s,year=%s,sem=%s,student_name=%s,class_division=%s,roll_no=%s,photo_sample=%s where student_id=%s",(
                                                      self.var_dep.get(),
                                                      self.var_course.get(),
                                                      self.var_year.get(),
                                                      self.var_sem.get(),
    ...
    def delete_data(self):
        if self.var_SID.get()=="":
            ...
            try:
                delete=messagebox.askyesno("Do You Want to Delete",parent=root)
                if delete>0:
                  conn = mysql.connector.connect(host="localhost", user="root", password="bishal10@",
                                           database="face_detection")
                  my_curser = conn.cursor()
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_student_name.get()=="" or self.var_SID.get()=="" :
            messagebox.showerror("Error","All Fields Are Required",parent=self.root)
             ...
             try:
                  conn=mysql.connector.connect(host="localhost",user="root",password="bishal10@",database="face_detection")
                  my_curser=conn.cursor()
                  my_curser.execute("insert into student values(%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
        ...
        if self.var_dep.get()=="Select Department" or self.var_student_name.get()=="" or self.var_SID.get()=="" :
            ...
            try:
               ...
               for x in myresult:
                   id+=1
               my_curser.execute(
                "update student set dep=%s,course=%s,year=%s,sem=%s,student_name=%s,class_division=%s,roll_no=%s,photo_sample=%s where student_id=%s",
                 (
                       self.var_dep.get(),
                      self.var_course.get(),
                    self.var_year.get(),
